...
test('addContainerSensor must publish sensor discovery message expected by HA', async () => {
    ...
    expect(mqttClientMock.publish).toHaveBeenCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_watcher-name_container-name',
...
test('updateContainerSensors must publish all sensors expected by HA', async () => {
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_total_count',
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_update_count',
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_update_status',
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_watcher-name_total_count',
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_watcher-name_update_count',
    ...
    expect(mqttClientMock.publish).toHaveBeenNthCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_watcher-name_update_status',
...
test('updateWatcherSensors must publish all watcher sensor messages expected by HA', async () => {
    ...
    expect(mqttClientMock.publish).toHaveBeenCalledWith(
        ...
        JSON.stringify({
            ...
            default_entity_id: 'topic_watcher-name_running',
