...
jest.spyOn(fs, 'readFileSync').mockReturnValue('<html><body><div id="app"></div></body></html>');
...
describe('API UI', () => {
    ...
    test('should serve index html and inject basepath', async () => {
        ...
        expect(res.text).toContain('<script>window.__WUD_BASE_PATH__=\'/wud\'</script><div id="app">');
    });
});
