Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must handle different registry types and update patterns
    ...
    Examples:
      ...
      | 1     | ghcr.private   | ghcr_radarr              | https://ghcr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.3.0.10514-ls316 | true            | GHCR complex semver update   |
      ...
      | 6     | lscr.private   | lscr_radarr              | https://lscr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.3.0.10514-ls316 | true            | LSCR complex semver update   |
