Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 5     | hub      | hub_homeassistant_202161 | https://registry-1.docker.io/v2                         | homeassistant/home-assistant        | 2021.6.1           | 2024.12.3          | true            |
  ...
  Scenario: WUD must allow to get a container with its link
    ...
    And response body path $.result.link should be https://github.com/home-assistant/core/releases/tag/2024.12.3
