Feature: Prometheus exposure
  ...
  Scenario Outline: WUD must expose watched containers
    ...
    Examples:
      ...
      | ghcr_radarr              | ghcr.private | https://ghcr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.3.0.10514-ls314 | false           |
      | hub_alpine_latest        | hub.public   | https://registry-1.docker.io/v2                         | library/alpine               | latest            | latest            | false           |
      | hub_homeassistant_202161 | hub.public   | https://registry-1.docker.io/v2                         | homeassistant/home-assistant | 2021.6.1          | 2026.9.1          | false           |
      | hub_nginx_latest         | hub.public   | https://registry-1.docker.io/v2                         | library/nginx                | latest            | latest            | true            |
      | lscr_radarr              | lscr.private | https://lscr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.3.0.10514-ls314 | true            |
