Feature: Prometheus exposure
  ...
  Scenario Outline: WUD must expose watched containers
    ...
    Examples:
      ...
      | ghcr_radarr              | ghcr.private | https://ghcr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.4.4.10685-ls317 | false           |
      ...
      | lscr_radarr              | lscr.private | https://lscr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.4.4.10685-ls317 | true            |
