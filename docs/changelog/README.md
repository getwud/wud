...
- :star: Add [HTTPS/TLS support](configuration/server/?id=server)
- :star: Add ability to customize container display names and icons ([see `wud.display.name` and `wud.display.icon`](configuration/watchers/?id=label))
- :star: Add ability to link container versions to release notes or changelogs ([see documentation](configuration/watchers/?id=associate-a-link-to-the-container-version))
...
- :star: Add tag transform rules before update analysis ([see documentation](configuration/watchers/?id=transform-the-tags-before-performing-the-analysis))
...
- :star: Allow storing [secrets in external files](configuration/?id=secret-management)
